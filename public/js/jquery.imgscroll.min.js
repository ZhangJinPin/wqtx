...
var imgScroll = {
	...
	gradual: function (b, e, c) {
		...
		1 == c && ($("." + a).css({
				...
				position: "absolute"
			}), (0 < $("." + a + ">.pre").length || 0 < $("." + a + ">.next").length) && $("." + a + ">.pre,." + a + ">.next")
			.css({
				position: "absolute"
			}));
		if (0 < g) {
	...
	myGradual: function (b, e, c) {
		...
		0 < c.descli && ($("." + b + ">.imgdesc li:eq(" + e + ")").siblings().removeClass("hover"), $("." + b +
			">.imgdesc li:eq(" + e + ")").addClass("hover"));
		if (0 < c.infoli)
	...
	myScroll: function (b, e, c, m, a, l, d) {
		imgScroll.addDataIndex(b, e);
		0 < d.descli && ($("." + b + ">.imgdesc li:eq(" + e + ")").siblings().removeClass("hover"), $("." + b +
			">.imgdesc li:eq(" + e + ")").addClass("hover"));
		if (0 < d.infoli)
			if (textindex = "right" == c || "bottom" == c ? parseInt(l - 1 - e) : e, "gradual" == d.imginfo) $("." + b +
					">.imginfo li:eq(" + textindex + ")").siblings().stop().fadeTo(500, 0),
	...
	rolling: function (b) {
		function e() {
			g >= l * f / 2 && ("left" == a || "top" == a) ? g = 0 : g <= l * f / 2 - h && ("right" == a || "bottom" == a) && (
				g = l * f - h);
			switch (a) {
				case "left":
					c.find("ul").animate({
